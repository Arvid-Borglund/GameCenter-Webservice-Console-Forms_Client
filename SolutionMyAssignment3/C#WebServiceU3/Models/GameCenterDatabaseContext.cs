    ...
    public partial class GameCenterDatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email).HasName("UQ__Customer__AB6E616446111CC3").IsUnique();
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email).HasName("UQ__Employee__AB6E616468C38B68").IsUnique();
            ...
            modelBuilder.Entity<Game>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.ComputerId, e.Title }).HasName("UQ__Game__33E936A5B509FABA").IsUnique();
